...
def ipt_solver_para_mag(beta, u_int, g_0_wn_up, wn, tau, n_up, loop):
    ...
    print_g_sigma(wn, tau, g_0_wn_up, g_0_wn_up, g_0_tau_up, g_0_tau_up,
                  sigma_tau_up, sigma_tau_up, loop)

    return g_wn_up, sigma_wn_up

def ipt_solver_anti_ferr(beta, u_int, g_0_wn_up, g_0_wn_dn, wn, tau, 
                         n_up, n_dn, loop):    
    mu = u_int / 2
...
def loop(u_int, t, g_wn_up, g_wn_dn, wn, tau, beta,
    ...
    while not converged:
        ...
        if (m_start != 0.):
            ...
            g_wn_dn, \
            sigma_wn_up, \
            sigma_wn_dn = ipt_solver_anti_ferr(beta, u_int, g_0_wn_up, g_0_wn_dn, wn, 
                                               tau, n_up, n_dn, loops)  
        else:
            g_wn_up, \
